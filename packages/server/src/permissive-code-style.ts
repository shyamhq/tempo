...
// and pass no `styleSpecs` override in `plan-schema.ts` / `plan-schema-client.ts`
// — the upstream default will be the same. AGENTS.md "Upstream watches"
// tracks this for periodic review.
// ---------------------------------------------------------------------------
