...
- [ ] **0.5 Install design system + observability in both apps** — shadcn/ui init in Console, Tailwind v4, Lucide, run `npx getdesign@latest add linear.app --out apps/console/DESIGN.md`, derive `globals.css`. Pino + env.ts in both apps.
