// TODO(slice-1b-review): WORKFLOW is duplicated from apps/console/server/workflow.ts
// pending Dev decision per judge note 3 of the slice-1b plan.
// Resolution: lift into @tempo/contracts (or packages/shared) in slice-1c,
// then delete this file and update both apps to import from the shared package.
// The options with tradeoffs are in the slice-1b implementation report.
