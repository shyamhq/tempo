...
// hosted-package.json brings in the Vercel AI SDK + the Moonshot
// (OpenAI-compatible) provider + Tavily web tools + the official MCP
// filesystem server. ripgrep is apt-installed for the native Grep tool.
// No 251 MB Claude Code binary; no libc workaround.
