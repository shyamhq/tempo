...
await $`bun build --target=node --bundle --external='ai' --external='@ai-sdk/*' --external='@tavily/*' --external='@modelcontextprotocol/*' --external='zod' src/hosted/runner.ts --outfile e2b/hosted-runner.js`;
