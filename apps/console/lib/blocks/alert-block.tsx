...
// Client React variant of the `alert` callout block. Registered in
...
// graph from here is client-only. Server uses `alert-block.server.ts`.
// Both specs share `alert-block-shared.ts` so they agree on type /
