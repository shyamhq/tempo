...
// GET /api/threads/:id/agent-messages — the persisted agent UIMessages.
// Refetched on agent_turn_ended so the merge dedups the just-finished live turn
// by id. Mirrors apps/console/app/api/threads/[id]/agent-messages/route.ts.
