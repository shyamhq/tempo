...
//
// Ported from apps/console's RepoPicker onto console-redo's tokens + Radix Dialog.
// No TanStack Query (console-redo doesn't use it): a cancel-guarded fetch runs
